...
public class PlayerCollisionScript : MonoBehaviour
{
    ...
    {
        if(collision.gameObject.tag == "Checkpoint" && playerScript.GetCanMove()) //checkpoint triggered
        {
            //set reset position of checkpoint script to the position of the checkpoint the player just touched
            checkpointManagerScript.SetResetPosition(collision.gameObject.transform.position);
        }
        else if(collision.gameObject.tag == "End" && playerScript.GetCanMove()) // end point triggered
        {
